...
import { MailIcon, DatabaseIcon, WrenchIcon, SPLogo } from "../../PropertyAutomation/components/Icons";
...
export const ClosingScene: React.FC = () => {
  ...
  const workflows = [
    { icon: <DatabaseIcon size={28} color={COLORS.blue} />, color: COLORS.blue, label: "Document Automation", startX: -300, startY: -300 },
    { icon: <MailIcon size={28} color={COLORS.purple} />, color: COLORS.purple, label: "Smart Follow-Ups", startX: 300, startY: -300 },
